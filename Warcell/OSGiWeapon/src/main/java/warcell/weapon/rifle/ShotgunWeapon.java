    ...
    public void shoot(Entity entity, GameData gameData, World world) {
        if (entity.getPart(ShootingPart.class) != null) {
            ...
            if (shootingPart.isShooting()) {
                ...
                bullet = createBullet(positionPart.getX() + entity.getRadius(), positionPart.getY() + entity.getRadius(), positionPart.getRadians() + (rand.nextFloat() * (1-2)), shootingPart.getID());
